      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Join Short.ly and start shortening URLs
          </p>
          <div className="mt-3 p-3 bg-green-50 border border-green-200 rounded-md">
            <p className="text-xs text-green-700 font-medium mb-1">Quick Demo:</p>
            <p className="text-xs text-green-600">📧 Try: yourname@example.com</p>
            <p className="text-xs text-green-600">🔒 Min 6 characters password</p>
          </div>
        </div>
